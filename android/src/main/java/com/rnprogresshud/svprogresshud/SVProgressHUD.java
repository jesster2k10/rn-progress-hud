package com.rnprogresshud.svprogresshud;
...
import com.rnprogresshud.R;
import com.rnprogresshud.svprogresshud.listener.OnDismissListener;
import com.rnprogresshud.svprogresshud.view.SVCircleProgressBar;
import com.rnprogresshud.svprogresshud.view.SVProgressDefaultView;
...
public class SVProgressHUD {
    ...
    private static long minimumDismissTimeInterval = 1000;
    ...
    public static SVProgressHUD withContext(Context context) {
      if (context instanceof ReactApplicationContext) {
        return new SVProgressHUD(((ReactApplicationContext) context).getCurrentActivity());
      }
    ...
    public void setMinimumDismissTimeInterval(long interval) {
    ...
    public SVProgressHUD setFontName(String string) {
      mSharedView.setFontName(string);
      return this;
    }

    public SVProgressHUD setFontSize(Integer size) {
      mSharedView.setFontSize(size);
      return this;
    }

    public SVProgressHUD setMaskType(SVProgressHUDMaskType maskType) {
    ...
    public void dismiss() {
      System.out.println(isDismissing);
    ...
    private void scheduleDismiss() {
        mHandler.removeCallbacksAndMessages(null);
        mHandler.sendEmptyMessageDelayed(0, minimumDismissTimeInterval);
    }
