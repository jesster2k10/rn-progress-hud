package com.rnprogresshud.svprogresshud.view;
...
public class SVProgressDefaultView extends LinearLayout {
    ...
    public void setFontName(String fontName) {
      tvMsg.setTypeface(Typeface.create(fontName, Typeface.NORMAL));
    }

    public void setFontSize(Integer fontSize) {
      tvMsg.setTextSize(TypedValue.COMPLEX_UNIT_SP, fontSize);
    }
    ...
    private void clearAnimations() {
      System.out.println("Clear animations");
